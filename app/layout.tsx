...
import { LucideHome, LucideBarChart2, LucideSun, LucideMoon, LucideLogOut } from "lucide-react";
...
function NavContent() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 left-0 w-full bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 z-50">
      ...
      {/* Navigation Links - Consistent across mobile and desktop */}
    ...
    <html lang="en">
      <body className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        <AuthProvider>
          ...
          <nav className="fixed bottom-0 left-0 w-full bg-white dark:bg-gray-800 md:w-64 md:h-screen md:fixed md:left-0 md:top-0 border-t md:border-r border-gray-200 dark:border-gray-700 z-50">
          ...
          <main className="md:ml-64 p-4 pt-16 md:pt-4">
            {children}
          </main>
        </AuthProvider>
      </body>
